  ...
  return (
    <div className="w-full min-h-[100vh] flex flex-col items-center bg-gradient-to-br from-zinc-50 to-white relative overflow-hidden">
      ...
      >
        ...
        >
          Наша миссия — предоставлять клиентам надёжные, качественные и долговечные строительные решения.
        </motion.p>
        <motion.button
      ...
      >
        {stats.map((stat, i) => (
          ...
          >
            ...
            <span className="text-zinc-600 text-base font-semibold">{stat.label}</span>
          </motion.div>
        ))}
      </motion.section>
      ...
      >
        <div className="flex-1 flex flex-col justify-center">
          <h2 className="text-3xl font-bold mb-3 text-blue-700">О компании EuroStroy</h2>
          <p className="text-zinc-700 mb-5 text-lg">
            EuroStroy — ведущая компания в Ташкенте и по всему Узбекистану, специализирующаяся на оказании профессиональных строительных и сантехнических услуг. Наша команда опытных специалистов предлагает современные решения для квартир, домов, офисов и промышленных объектов.
          </p>
      ...
      <motion.section
        ...
        viewport={{ once: true }}
      >
        <h3 className="text-2xl font-bold mb-8 text-center text-blue-700">Наши услуги</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {services.map((service, i) => (
            ...
            >
              ...
              <span className="font-semibold text-lg mb-2 text-blue-900">{service.title}</span>
              <span className="text-zinc-600 text-center text-base">{service.desc}</span>
            </motion.div>
          ))}
        </div>
      </motion.section>
      ...
      >
        <div className="flex-1 flex flex-col justify-center mb-6 md:mb-0">
          <h3 className="text-2xl font-bold mb-2 text-blue-700">Где мы находимся</h3>
          <p className="mb-3 text-zinc-700">г. Ташкент, ул. Мукими, 12</p>
          <p className="mb-2 text-zinc-700">Телефон: <a href="tel:+998901234567" className="text-blue-600 hover:underline">+998 (90) 123-45-67</a></p>
          <p className="mb-2 text-zinc-700">Пн-Сб: 9:00 — 19:00</p>
          <p className="mb-2 text-zinc-700">E-mail: <a href="mailto:info@eurostroy.uz" className="text-blue-600 hover:underline">info@eurostroy.uz</a></p>
        </div>
